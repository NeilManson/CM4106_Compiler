...
namespace Compiler.SyntacticAnalysis
{
    ...
    public class Parser
    {
        ...
        /// </summary>
        /// <returns>An abstract syntax tree representing the quick if command</returns>
        private ICommandNode ParseQuickIfCommand()
        {
            ...
            return new QuickIfCommandNode(expression, doCommand, startPosition);
        }
        ...
        /// Parses Loop command
        /// </summary>
        /// <returns> An abstract syntax tree representing the loop command</returns>
        private ICommandNode ParseLoopCommand()
        {
            ...
            ICommandNode command = ParseSingleCommand();
            Accept(While);
            IExpressionNode expressionNode= ParseBracketExpression();
            ICommandNode command2 = ParseSingleCommand();
            return new LoopCommandNode(command, expressionNode, command2, startPosition);
        }
